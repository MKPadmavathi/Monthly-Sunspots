...
data<- read_csv("C:/Users/RAJA/Downloads/monthly-sunspots.txt")
View(data)
...
#train and test
train <- ts(sunspots[1:2808,2],start=1749,frequency = 12)
train
test <- ts(sunspots[2809:2812,2],start=1983,frequency = 12)
test
